...
System::System(const string &strVocFile, const string &strSettingsFile, const eSensor sensor,
               const bool bUseViewer, bool bReuse,std::string mapName, bool continue_mapping, bool isPangolinExists):mSensor(sensor),mbReset(false),mbActivateLocalizationMode(bReuse),
...
void System::LoadMap(const string &filename)
{
   ...
   // cout << endl << filename <<" : Map Loaded!" << endl;
    ...
    std::fstream file(filename, ios::binary);
    auto my_str = string();
